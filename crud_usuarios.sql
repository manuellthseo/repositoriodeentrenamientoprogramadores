...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-07-2022 a las 04:19:42
...
CREATE TABLE `usuarios` (
  ...
  `imagene` varchar(255) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `telefono` varchar(255) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `email` varchar(255) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `fecha_creacion` varchar(255) COLLATE utf8mb4_spanish2_ci NOT NULL
